...
async function initAfterAuth(){
  ...
  const me = await api('/me'); if(!me.error){ meName.textContent = me.username; meXp.textContent = me.xp||1000; meLevel.textContent = me.level||Math.floor((me.xp||1000)/10); if(me.avatar) meAvatar.src = me.avatar; if(me.isAdmin) adminLink.style.display='block'; }
